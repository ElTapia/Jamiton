...
base_folder = "rho_s_{rho}_Final_time_{T}".format(rho=rho_s, T=T)
...
for n in range(len(dxs)):
    ...
    t, rho, y = solve_ARZ(Q_0, x, tau, T, Nt, F_HLL_rho, F_HLL_y, s_max, as_array=False)
    u = y/rho - h(rho)
